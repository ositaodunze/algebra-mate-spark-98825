...
import { Sparkles, Lightbulb, Target, Gamepad2, ChevronRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      {currentSectionId === "vocab" && (
        ...
        >
          ...
          <div className="flex justify-center mt-8">
            <Button 
              onClick={() => markSectionComplete("vocab")}
              size="lg"
              className="group"
            >
      ...
      {currentSectionId === "application" && (
        ...
        >
          ...
          <div className="flex justify-center mt-8">
            <Button 
              onClick={() => markSectionComplete("application")}
              size="lg"
              className="group"
            >
      ...
      {currentSectionId === "concept" && (
        ...
        >
          ...
          <div className="flex justify-center mt-8">
            <Button 
              onClick={() => markSectionComplete("concept")}
              size="lg"
              className="group"
            >
      ...
      {currentSectionId === "recap" && (
        ...
        >
          ...
          <div className="flex justify-center mt-8">
            <Button 
              onClick={() => markSectionComplete("recap")}
              size="lg"
              className="group"
            >
      ...
      {/* Completion Message */}
      {completedSections.includes("assessment") && (
        <div className="bg-card border-t border-border py-12 mb-20">
          <div className="container max-w-5xl mx-auto px-4 text-center">
            <div className="mb-4 text-6xl">🎉</div>
            <h2 className="text-3xl font-bold mb-4">Congratulations!</h2>
            <p className="text-lg text-muted-foreground">
              You've completed the Expressions & Variables lesson!
            </p>
          </div>
        </div>
      )}
